...
variable "terraform_iam_policy_name_prefix" {
  description = "Creates a unique name beginning with the specificed prefix"
  type        = string
  default     = "terraform"
}
...
variable "dynamodb_table_billing_mode" {
  description = "Control how you are charged for read and write throughput and how you manage capacity."
  type        = string
